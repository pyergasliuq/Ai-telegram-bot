...
class Settings(BaseModel):
    ...
    BOT_TOKEN: str = ""
    ADMIN_IDS_RAW: str = Field(default="2080411409")
    ...
    PROVIDER_AUTH_COOLDOWN_S: int = 3600
    PROVIDER_NOT_FOUND_COOLDOWN_S: int = 1800
    PROVIDER_RATE_LIMIT_COOLDOWN_S: int = 60
    PROVIDER_MAX_FAILS: int = 5
...
_ENV_ALIASES: dict[str, str] = {"ADMIN_IDS_RAW": "ADMIN_IDS"}
...
def get_settings() -> Settings:
    ...
    for name in Settings.model_fields:
        env_key = _ENV_ALIASES.get(name, name)
