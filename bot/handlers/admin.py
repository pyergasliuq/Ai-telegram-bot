...
from bot.config.settings import Plan, settings
...
from bot.handlers.keyboards import admin_menu_kb
from bot.handlers.states import AdminStates
from bot.services.promo import PromoError, create_admin_promo
...
async def admin_grant(cq: CallbackQuery, session: AsyncSession, lang: str) -> None:
    ...
    if not target:
        ...
        return
    from bot.services.payments import activate_subscription
